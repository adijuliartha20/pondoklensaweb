 ...
 * Description:       Handle the website info.
 * Version:           1.0.0
...
class MySettingsPage{
    ...
    public function page_init(){        
        ...
        add_settings_field('twitter', 'Twitter', array( $this, 'twitter_callback' ), 'my-setting-admin', 'setting_section_id'); 
        ...
        add_settings_field('fax', 'Fax', array( $this, 'fax_callback' ), 'my-setting-admin', 'setting_section_id_2');  
    ...
    public function sanitize( $input ){
        ...
        if( isset( $input['twitter'] )) $new_input['twitter'] = sanitize_text_field( $input['twitter'] );
        ...
        if( isset( $input['fax'] )) $new_input['fax'] = sanitize_text_field( $input['fax'] );
